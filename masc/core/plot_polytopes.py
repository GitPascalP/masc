...
tau = 1
A_d, B_d, C_d, D_d, Mx, wx, Mu, wu, Q, R, S = control_utils.get_state_space(
    a, obs_limits, act_limits, tau
)
n, m = B_d.shape

feasible_set3d = control_utils.calc_feasible_set(
    A_d, B_d, Q, R, Mx, wx, Mu, wu, project_dim=[1, 2, 3], N_max=50, tol=0.01,
    discount=1, N_start=1, progress_bar=True)

feasible_set2d = control_utils.calc_feasible_set(
